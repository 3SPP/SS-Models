...
class HRNet(nn.Layer):
    ...
    def reset_layer1(self, in_channels):
        self.conv_layer1_1 = ConvBNReLU(
            in_channels=in_channels,
            out_channels=64,
            kernel_size=3,
            stride=2,
            padding=1 if not self.padding_same else 'same',
            bias_attr=False)
...
def HRNet_W18_Small_V1(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[1],
...
def HRNet_W18_Small_V2(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[2],
...
def HRNet_W18(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W30(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W32(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W40(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W44(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W48(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W60(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
...
def HRNet_W64(in_channels=3, **kwargs):
    model = HRNet(
        in_channels=in_channels,
        stage1_num_modules=1,
        stage1_num_blocks=[4],
